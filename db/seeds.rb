...
customer3 = Customer.create(first_name: 'Alice', last_name: 'Johnson', email: 'alice@example.com', address: '789 Elm St')
...
sub3 = Subscription.create(title: 'Weekly Oolong Tea', price: 12.99, status: 'active', frequency: 7, customer: customer3, tea: tea3)
sub4 = Subscription.create(title: 'Monthly Herbal Tea', price: 9.99, status: 'active', frequency: 30, customer: customer4, tea: tea4)
sub5 = Subscription.create(title: 'Bi-weekly White Tea', price: 11.99, status: 'active', frequency: 14, customer: customer1, tea: tea5)